...
pub extern fn printf(format: [*c]const u8, ...) void;
pub extern fn convert(num: c_uint, base: c_int) [*c]u8;
pub extern fn cputs(c: [*c]const u8) void;
...
pub const __CLANG_ATOMIC_CHAR_LOCK_FREE = 1;
pub const __INT_LEAST16_FMTi__ = c"hi";
pub const __GCC_ATOMIC_SHORT_LOCK_FREE = 1;
pub const UINTMAX_MAX = __UINTMAX_MAX__;
pub const INT_LEAST64_MAX = __INT_LEAST64_MAX;
pub const INTPTR_MAX = __INTPTR_MAX__;
pub const __SIZE_FMTX__ = c"lX";
pub const INTMAX_MIN = if (@typeId(@typeOf(-1)) == @import("builtin").TypeId.Pointer) @ptrCast(-__INTMAX_MAX__, -1) else if (@typeId(@typeOf(-1)) == @import("builtin").TypeId.Int) @intToPtr(-__INTMAX_MAX__, -1) else (-__INTMAX_MAX__)(-1);
...
pub const __riscv_float_abi_soft = 1;
pub const __CLANG_ATOMIC_SHORT_LOCK_FREE = 1;
...
pub const __CLANG_ATOMIC_INT_LOCK_FREE = 1;
...
pub const __CLANG_ATOMIC_WCHAR_T_LOCK_FREE = 1;
...
pub const __CLANG_ATOMIC_POINTER_LOCK_FREE = 1;
pub const __UINTPTR_FMTX__ = c"lX";
pub const __WINT_WIDTH__ = 32;
pub const __SHRT_MAX__ = 32767;
pub const __GCC_ATOMIC_BOOL_LOCK_FREE = 1;
pub const __POINTER_WIDTH__ = 64;
pub const PTRDIFF_MIN = if (@typeId(@typeOf(-1)) == @import("builtin").TypeId.Pointer) @ptrCast(-__PTRDIFF_MAX__, -1) else if (@typeId(@typeOf(-1)) == @import("builtin").TypeId.Int) @intToPtr(-__PTRDIFF_MAX__, -1) else (-__PTRDIFF_MAX__)(-1);
...
pub const __GCC_ATOMIC_INT_LOCK_FREE = 1;
...
pub const __GCC_ATOMIC_CHAR16_T_LOCK_FREE = 1;
...
pub const __GCC_ATOMIC_CHAR_LOCK_FREE = 1;
pub const __INTMAX_WIDTH__ = 64;
pub const __CLANG_ATOMIC_BOOL_LOCK_FREE = 1;
...
pub const __GCC_ATOMIC_LONG_LOCK_FREE = 1;
pub const __ORDER_PDP_ENDIAN__ = 3412;
pub const __INT_FAST64_FMTd__ = c"ld";
pub const INT_LEAST8_MIN = __INT_LEAST8_MIN;
pub const __INT_LEAST8_MIN = INT64_MIN;
pub const __CLANG_ATOMIC_LONG_LOCK_FREE = 1;
pub const __GXX_ABI_VERSION = 1002;
pub const __INT16_TYPE__ = short;
pub const INTPTR_MIN = if (@typeId(@typeOf(-1)) == @import("builtin").TypeId.Pointer) @ptrCast(-__INTPTR_MAX__, -1) else if (@typeId(@typeOf(-1)) == @import("builtin").TypeId.Int) @intToPtr(-__INTPTR_MAX__, -1) else (-__INTPTR_MAX__)(-1);
...
pub const __CLANG_ATOMIC_CHAR16_T_LOCK_FREE = 1;
...
pub const __GCC_ATOMIC_WCHAR_T_LOCK_FREE = 1;
...
pub const __riscv_cmodel_medlow = 1;
pub const __SIZEOF_INT__ = 4;
pub const __GCC_ATOMIC_POINTER_LOCK_FREE = 1;
...
pub const __GCC_ATOMIC_CHAR32_T_LOCK_FREE = 1;
...
pub const __CLANG_ATOMIC_CHAR32_T_LOCK_FREE = 1;
